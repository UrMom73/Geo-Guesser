...
console.log("Also, people kept making this mistake, so let me just tell you. When you're calling the function, don't press the 'Run' button! Just press enter on your keyboard.");
...
function geoGuesser(city,country) {
  ...
  if(city == null && country == null && round == 0) {
    ...
    if(city == 'london' && country == 'england') {
      ...
      console.log("That's right!");
    }else if(city == 'london' && country == 'united kingdom') {
      console.log("That's right!");
    }else {
      score--
    ...
    console.log("Description: The Colosseum is located in this place.");
  }else if(round == 4) {
    ...
    if(city == 'jakarta' && country == 'indonesia') {
      ...
      score--
      console.log("Incorrect! That was an EASY one, you should be ashamed!! >:)");
